	...
	: Super(PCIP)
{
	...
	StorageSlot = EInventorySlot::Rifle;
...
class APlayerCharacter* AWeapon::GetPawnOwner() const
{
	return MyPawn;
}
...
void AWeapon::OnEquipWeapon(bool bPlayAnimation)
{
	bPendingEquip = true;
...
void AWeapon::OnEnterInventory(APlayerCharacter* NewOwner)
{
...
UAudioComponent* AWeapon::PlayWeaponSound(USoundBase* SoundToPlay)
{
